...
export SONARQUBE_USERNAME="${SONARQUBE_USERNAME:-aisxodde}" # only used during the first initialization
export SONARQUBE_PASSWORD="${SONARQUBE_PASSWORD:-@ais888oddelnwbellza5558989}" # only used during the first initialization
